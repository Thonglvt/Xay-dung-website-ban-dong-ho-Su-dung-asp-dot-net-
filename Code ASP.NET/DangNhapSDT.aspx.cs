...
public partial class DangNhapSDT : System.Web.UI.Page
{
    ...
    {
        txt_user.Attributes.Add("Placeholder", "Nhập số điện thoại đã đăng ký tài khoản");
        txt_password.Attributes.Add("Placeholder", "Nhập mật khẩu");
    }
    ...
    {
        cn.Open();
        string ad = "SELECT * from KHACHHANG where PHONE = @tenDangNhap and PASSWORD_= @pass";
