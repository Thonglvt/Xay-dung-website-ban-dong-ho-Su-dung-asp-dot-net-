...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div style="margin-top:100px;margin-left:200px;">
        <asp:DataList ID="dl_Search" runat="server" RepeatColumns="3">
            <ItemTemplate>
                <table class="tb_sanPham">
                    <tr>
                        <td class="row_sanPham">
                            ...
                            <asp:HyperLink ID="hl_name" runat="server" Font-Size="Medium" Text='<%# Eval("NAME_SP") %>'  Font-Underline="False" ForeColor="Maroon" NavigateUrl='<%# "ChiTietSanPham.aspx?ID_SP="+Eval("ID_SP")+"&thuongHieu="+Eval("tenTH") %>' Target="_blank"></asp:HyperLink>     
                            <br /><br />
